...
<%@page import="es.unizar.sisinf.data.dao.UsuarioDAO"%>
				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<span class="lnr lnr-arrow-right"></span>  <a href="jsp/otroPerfil.jsp"> Perfil de </a></p>
						</div>	
					</div>
				</div>
			</section>
						...
						<div class="menu-content pb-70 col-lg-8">
							<div class="title text-center">
								<%String[] usuario= request.getParameterValues("user");
									UsuarioVO u = findById(usuario[0]);
									String us = usuario[0];%>
		           				<h3> <%= u.getNom()%> &nbsp <%= u.getApell()%> </h3><br/>
										
								<p><% Double p = (Double)request.getAttribute("puntuacion"); %><%=p%></p>	
								<p><%=u.getnOpiniones()%>&nbsp;opiniones</p>	
		                    <h6>Tel̩fono: &nbsp;<%=u.getTlf()%></h6>
		                    <br/>
		                    <h6>Email: &nbsp;<%=u.getEmail()%></h6>
		                    	<div class="title text-center">
									<a onclick="()" class="primary-btn text-uppercase" style="margin-left:20px"> <% request.setAttribute("userCon", u.getEmail()); %>Enviar mensaje</a>
								</div>
		          			</div>
