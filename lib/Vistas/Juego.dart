                  ...
                  "jugadores": FieldValue.arrayRemove([
                    {
                      ...
                      "score": sesion.partidaActual.jugadores
                          .singleWhere((jugador) =>
                              jugador.usuario.email == sesion.usuario.email)
                          .score,
                    }
                  ]),
                    ...
                    builder: (context, sesion, child) {
                      ...
                      for (Mensaje mensaje in newChat) {
                        ...
                        if (mensaje.contenido.trim().toLowerCase() ==
                          ...
                          while (
                              sesion.partidaActual.jugadores[i].usuario.email !=
                                  mensaje.usuario.email) {
                            jugadoresActualizados[i] = new Jugador(
                                sesion.partidaActual.jugadores[i].usuario,
                ...
                if (estado.hasData) {
                  if (estado.data == 'esperarJugadores') {
                    ...
                    return AlertDialog(
                      title: Text("Esperando..."),
                      content: Text(
                          '${sesion.partidaActual.jugadores[sesion.partidaActual.turno].usuario.apodo} está eligiendo palabra'),
                    );
                  } else if (contador == 0 ||
                    ...
                    if (sesion.usuario.email ==
                        sesion
                            .partidaActual
                            .jugadores[sesion.partidaActual.turno]
                            .usuario
                            .email) {
                      return AlertDialog(
