          ...
          children: <Widget>[
            new Card(
              ...
              child: Container(
                ...
                child:
                    const Text('Nueva Partida', style: TextStyle(fontSize: 20)),
              ),
            ),
            Slider(
            ...
            new Card(
              ...
              child: Container(
                ...
                child: const Text('Código', style: TextStyle(fontSize: 20)),
              ),
            ),
            new Card(
              borderOnForeground: true,
              ...
              child: TextFormField(
                  ...
                  validator: (value) =>
                      value.isEmpty ? 'codigo esta vacio' : null,
            ...
            new Card(
              ...
              child: Container(
                ...
                child: const Text('Partida Existente',
              ...
              children: <Widget>[
                new Card(
                  ...
                  child: TextFormField(
                      ...
                      validator: (value) =>
                          value.isEmpty ? 'Numero de partida esta vacio' : null,
