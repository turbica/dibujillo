...
class Editar_Perfil_state extends State<EditarPerfil> {
  ...
  void initState() {
    Firestore.instance.collection('usuario').document(widget.usuario.email).get().then((usuario){
      usuario["phtoUrl"] == null ? urlFoto = usuario["photoUrl"]
          : urlFoto = "https://cdn.computerhoy.com/sites/navi.axelspringer.es/public/styles/855/public/media/image/2018/08/fotos-perfil-whatsapp_16.jpg?itok=iohCz0oN";
      setState(() {
            ...
            child: Column(
              ...
              children: <Widget>[
                    ...
                    children: <Widget>[
                          ...
                          Padding(
                            ...
                            child: CircleAvatar(
                                ...
                                child: SizedBox(
                                  width:180.0,
                                  height: 180.0,
                                  child: local ? Image.file(_image,fit:BoxFit.fill)
                                      : Image.network(
                                    urlFoto,
                                    fit:BoxFit.fill,
                                  ),
                      ...
                      new SizedBox(
                        ...
                        child: TextFormField(
                          ...
                          validator: (value) =>
                          value.isEmpty ? 'nickname esta vacio' : null,
                        ...
                        child: TextFormField(
                          decoration: InputDecoration(
                              ...
                              focusedBorder: UnderlineInputBorder(
                                  ...
                                  BorderSide(color: Colors.purpleAccent))),
                          validator: (value) =>
                          value.isEmpty ? 'name esta vacio' : null,
                ...
                FloatingActionButton(
                  ...
                  child: Icon(
                      Icons.delete_forever, color: Colors.white, size: 40.0),
                ),
              ],
            ),)
          ,
